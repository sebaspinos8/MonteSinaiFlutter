...
class BottomNavBarpacientes extends StatefulWidget {
  @override
  _BottomNavBarpacientesState createState() => _BottomNavBarpacientesState();
}

class _BottomNavBarpacientesState extends State<BottomNavBarpacientes> {
  int pageIndex = 1;
  ...
  Widget _firstPage = PacientePage();
