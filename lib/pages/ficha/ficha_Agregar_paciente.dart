...
import 'ficha_Agregar_page2.dart';

class FichaPacientePage extends StatefulWidget {
  static final String routeName = 'FichaPacientes';

  FichaPacientePage({Key key}) : super(key: key);
  @override
  _FichaPacientePageState createState() => _FichaPacientePageState();
}
                ...
                return Dismissible(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      FichaModel fichaModel = new FichaModel();
                      ...
                      pacienteuService
                        ...
                        Future.delayed(const Duration(milliseconds: 200), () {
                          fichaModel.nombre = value.nombre;
                          fichaModel.fechanac = value.fechanac;
                          fichaModel.mail = value.mail;
                          fichaModel.ident = value.ident;
                          fichaModel.direccion = value.direccion;
                          fichaModel.telefono = value.telefono;
                          fichaModel.proid = value.proid;
                          fichaModel.sucid = value.sucid;
                          fichaModel.pacid = this.pacientes[index].id;
                          fichaModel.fecha = metodos.formatoFechaDMA(
                              DateTime.now()
                                  .toString()
                                  .substring(0, 10)
                                  .replaceAll('-', '/'));
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      FichaAgregar2Page(fichaAux: fichaModel)));
                        });
                      });
                    },
                  ),
